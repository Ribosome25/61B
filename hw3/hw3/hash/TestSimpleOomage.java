...
public class TestSimpleOomage {
    ...
    public void testHashCodePerfect() {
        for (int r1 = 0; r1 < 256; r1+= 5) {
            for (int g1 = 0; g1 < 256; g1+= 5) {
                for (int b1 = 0; b1 < 256; b1+= 5) {
                    for (int r2 = 0; r2 < 256; r2+= 5){
                        for (int b2 = 0; b2 < 256; b2+= 5) {
                            for (int g2 = 0; g2 < 256; g2+= 5) {
                                SimpleOomage ooA = new SimpleOomage(r1, g1, b1);
                                SimpleOomage ooB = new SimpleOomage(r2, g2, b2);
                                if (ooA.equals(ooB)) {
